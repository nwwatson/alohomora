module Alohomora
  class Client < ActiveRecord::Base
    ...
    #
    # Model Attributes
    # uri                   client identifier (internal)
    # name                  client name
    # created_from          user who created the client
    # secret                client secret
    # site_uri              client website
    # redirect_uri          page called after authorization
    # scope, type           raw scope with keywords
    # scope_values,         scope parsed as array of allowed actions
    # info                  client additional info
    # granted_times,        tokens granted in the authorization step
    # revoked_times,        tokens revoked in the authorization step
    # blocked,              blocks any request from the client
    ...
    class << self
      ...
      def sync_clients_with_scope(scope)
        Alohomora::Client.all.each do |client|
